...
description: Typez le serveur, la configuration Syora et les scripts exécutés par Node.js.
---

Cette configuration couvre `server.ts`, `syora.config.ts` et les autres outils exécutés côté serveur.
