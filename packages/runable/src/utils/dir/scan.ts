...
/**
 * Exclude patterns shared by every Runable directory scanner.
...
/**
 * Fallback values shared by every Runable directory scanner, extended
 ...
 * Shared by all of Runable's auto-scan systems (components, composables, ...).
 *
...
/**
 * Result shape shared by every Runable directory scanner, extended with
