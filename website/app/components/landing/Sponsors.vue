...
<template>
  ...
  >
    ...
    <div class="relative mx-auto max-w-7xl px-10 py-32 md:py-40">
      ...
      <div ref="contentRef" class="mt-20">
        <div
          data-reveal
          class="sr-hidden relative overflow-hidden rounded-md border border-border bg-code p-8 sm:p-10"
        >
          <div
            aria-hidden="true"
        ...
        <div class="grid gap-3 mt-4">
          <article
            ...
            data-reveal
            class="sr-hidden group rounded-md border border-border bg-code p-6 transition-all hover:-translate-y-px hover:border-strong"
          >
