...
`adonis()` retourne un handler qui lit les objets Node internes depuis `HttpContext`, laisse Vite traiter les ressources en développement puis rend la page Syora.
